...
import CheckoutCartDialog from "@/components/element/shopping/CheckoutCartDialog";
          ...
          <div className="flex justify-between items-center gap-2 w-full">
            ...
            <div className="flex items-center gap-2 sm:gap-6">
              <div className={`hidden md:block`}>
                <a
                  href="tel:+84961036167"
                  className={`text-sm text-inherit flex items-center gap-2 ${
                    sticky
                ...
                <Dialog>
                  <form>
                    <DialogTrigger asChild>
                      <a
                        className={`text-sm text-inherit hover:cursor-pointer flex p-2 rounded-3xl items-center gap-2 ${
                          sticky
                            ? "text-foreground hover:bg-black  hover:text-primary border-white/50 dark:border-white/50"
                            : "text-white hover:text-black  border-white/50 hover:bg-white dark:border-white/50"
                        }`}
                      >
                        <ShoppingBag size={20} />
                      </a>
              ...
              <div>
                <Button
                  ...
                  className={`flex items-center gap-3 px-5 py-2.5 rounded-full hover:cursor-pointer border text-sm font-medium h-auto ${
                    sticky
