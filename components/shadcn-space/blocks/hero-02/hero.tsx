...
import { BadgeInfo, Car, ShoppingCart } from "lucide-react";
      ...
      <div className="bg-[url(https://images.shadcnspace.com/assets/backgrounds/real-estate-bg.webp)] bg-contain bg-center bg-repeat overflow-hidden relative flex flex-col xl:h-screen justify-center z-10 xl:gap-0 gap-12">
          ...
          <div className="relative text-white text-start z-30">
            ...
            <div>
              <Button className="px-6 py-3.5 bg-white border-0 text-black duration-300 hover:bg-white/80 font-medium rounded-full hover:cursor-pointer h-auto">
                <a href="/sign-in">Schedule time</a>
              </Button>
            </div>
          </div>
        </div>
        <div className="xl:absolute bottom-0 right-0 z-30 xl:w-auto lg:w-4/5 w-full lg:ms-auto">
          <div className="relative">
            <div className="xl:absolute bottom-12 w-full z-0">
              <img
                src={"/image/fixing.png"}
                alt="heroImg"
                width={956}
                height={897}
                className="w-full"
